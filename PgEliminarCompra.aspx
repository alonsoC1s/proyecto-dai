<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PgEliminarCompra.aspx.cs" Inherits="PgComfCompra" %>
      ...
      <div class="row">
        ...
        <div class="container-fluid">
          ...
          <div class="row justify-content-center ">
            ...
            <form runat="server">
                <div class="row justify-content-center ">
                    <asp:Button runat="server" CssClass="btn btn-primary bg-dark" Text="Eliminar Del Carrito" OnClick="compra_Click" />
                </div>
            </form>
        </div>
